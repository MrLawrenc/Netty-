 ...
 * 表明了几件事：
 * <pre>
 *     1. 是ThreadLocal变种，配合FastThreadLocalThread访问获取更好性能
 *     2. DefaultThreadFactory创建的线程均是FastThreadLocalThread
 *     3. 非FastThreadLocalThread线程来访问FastThreadLocal，均回退到常规ThreadLocal访问
 * </pre>
 */
